 ...
 */
public class Developers1Test extends TestCase {
    ...
    public void testLoadList2() {
        String output = Util.getLocalResource("examples/developers.yaml");
    ...
    public void testLoadAll() {
        String output = Util.getLocalResource("examples/developers.yaml");
         System.out.println(output);
        TypeDescription descr = new TypeDescription(Developer.class);
//        Yaml yaml = new Yaml(new Constructor(descr));
        Yaml yaml = new Yaml(new DeveloperConstructor());
Object object = yaml.load(output);

//        for (Object data : yaml.loadAll(output)) {
...
//        }
    ...
    class DeveloperConstructor extends Constructor {
        public DeveloperConstructor() {
